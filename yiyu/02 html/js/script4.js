$(function(e) {
    function t(t) {
        ...
        if (t = e.event.fix(s), t.type = "mousewheel", "detail" in s && (d = -1 * s.detail), "wheelDelta" in s && (d = s.wheelDelta), "wheelDeltaY" in s && (d = s.wheelDeltaY), "wheelDeltaX" in s && (r = -1 * s.wheelDeltaX), "axis" in s && s.axis === s.HORIZONTAL_AXIS && (r = -1 * d, d = 0), u = 0 === d ? r : d, "deltaY" in s && (d = -1 * s.deltaY, u = d), "deltaX" in s && (r = s.deltaX, 0 === d && (u = -1 * r)), 0 !== d || 0 !== r) {
            if (1 === s.deltaMode) {
                ...
                var c = e.data(this, "mousewheel-page-height");
                u *= c, d *= c, r *= c
            }
            return f = Math.max(Math.abs(d), Math.abs(r)), (!o || o > f) && (o = f, i(s, f) && (o /= 40)), i(s, f) && (u /= 40, r /= 40, d /= 40), u = Math[u >= 1 ? "floor" : "ceil"](u / o), r = Math[r >= 1 ? "floor" : "ceil"](r / o), d = Math[d >= 1 ? "floor" : "ceil"](d / o), t.deltaX = r, t.deltaY = d, t.deltaFactor = o, t.deltaMode = 0, a.unshift(t, u, r, d), l && clearTimeout(l), l = setTimeout(n, 200), (e.event.dispatch || e.event.handle).apply(this, a)
        }
    }
    ...
    var l, o, s = ["wheel", "mousewheel", "DOMMouseScroll", "MozMousePixelScroll"],
